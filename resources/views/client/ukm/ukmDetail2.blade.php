...
<html lang="en">
            ...
            <div class="page-content container-fluid col-xl-6">
                ...
                <div class=" desktop">
                    ...
                    <div class="first-headline card d-flex justify-content-between ">
                        <div class="name-ukm">
                            <h2>{{$ukmData->ormawas->namaSingkat}}</h2>
                            <h5>{{$ukmData->ormawas->namaLengkap}}</h5>
                            <div class="detail-headline">
                                ...
                                <div class="ketua">
                                    <h6>Ketua UKM</h6>
                                    <p>{{$ukmData->ketuaUmum}}</p>
                                </div>
                                <div class="dies-natalis">
                                    <h6>Tahun Berdiri</h6>
                                    <p>{{$ukmData->tahunBerdiri}}</p>
                                </div>
                            </div>
                        </div>
                        <div class="right-side-card">
                            ...
                            <!--qr code-->
                            <div class="qr-code">
                                <a class="qrCode" href="{{ route('ukmQR', $ukmData->ormawas_id)}}">
    ...
    <div class="footer-blue justify-content-around">
            ...
            <div class="icon-sosmed">
                ...
                <a href="{{ $ukm->socialmedias->youtube }}"><img src="{{ asset('assets') }}/images/yutub.png"></a>
