        ...
        <div class="main-wrapper">
            ...
            <div class="page-content container-fluid">
                ...
                <div class="scrolling-wrapper-flexbox">
                    <a href="{{ route('jurusan') }}" class="card justify-content-between" style="width: 280px; height: 170px;">
                        <div class="card-body" >
                    ...
                    <a href="{{ route('ukm') }}" class="card justify-content-between" style="width: 280px; height: 170px;">
                        <div class="card-body" >
                    ...
                    <a href="{{ route('prodi') }}" class="card justify-content-between" style="width: 280px; height: 170px;">
                        <div class="card-body" >
                    ...
                    <a href="{{ route('himpunan') }}" class="card justify-content-between" style="width: 280px; height: 170px; margin-right: 60px;">
                        <div class="card-body" >
