                        ...
                        <div class="col-sm-12 col-xl-8">
                            <div class="info-card card justify-content-between " style="height: 160px;" >
                                ...
                                <div class="info-card-body" >
                                    ...
                                    <p class="info-card-text">Guide PPLK merupakan pemandu bagi para mahasiswa/i baru untuk memberikan informasi yang ada di ITERA.</p>
                        ...
                        <div class="col-sm-12  col-xl-8">
                            <div class="info-card card justify-content-between " style="height: 160px;" >
                                ...
                                <div class="info-card-body" >
                                    ...
                                    <p class="info-card-text">Guide Game merupakan pemandu game PPLK yang berguna dalam memandu, menemani, dan memberikan informasi kepada mahasiswa/i baru yang sedang bermain game PPLK.</p>
                        ...
                        <div class="col-sm-12  col-xl-8">
                            <div class="info-card card justify-content-between " style="height: 160px;" >
                                ...
                                <div class="info-card-body" >
                                    ...
                                    <p class="info-card-text">Anthem PPLK merupakan Jingle khas PPLK ITERA berjudul Melodi Mimpi yang melambangkan dimulainya PPLK ITERA.</p>
