        ...
        <div class="main-wrapper">
            ...
            <div class="navbar p-0">
                <ul class="container-fluid footer-bar">
                        ...
                        <li>
                            <a href="{{ asset('assets') }}/html/index.html">
                        ...
                        <li>
                            <a href="{{ asset('assets') }}/html/biodata.html">
                                <svg class="icon" width="26" height="26" viewBox="0 0 26 26" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <path fill-rule="evenodd" clip-rule="evenodd" 
                        ...
                        <li>
                            <a href="{{ asset('assets') }}/html/tugas.html">
                                <svg class="icon" width="26" height="26" viewBox="0 0 26 26" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <path fill-rule="evenodd" clip-rule="evenodd" 
                        ...
                        <li>
                            <a href="{{ asset('assets') }}/html/games.html">
                                <svg class="icon" width="26" height="26" viewBox="0 0 26 26" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <path 
                        ...
                        <li style="margin-left: 0;">
                            <a href="{{ asset('assets') }}/html/leaderboard.html">
                                <svg class="icon" width="26" height="26" viewBox="0 0 26 26" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <path fill-rule="evenodd" clip-rule="evenodd" 
