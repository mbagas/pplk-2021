            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('dashboard.kamusGaul.store') }}">
                        ...
                        <div class="col-sm-10">
                            <input type="text" name="gaul" class="form-control form-control-lg" required>
                        </div>
                        </div>
                        ...
                        <div class="col-sm-10">
                            <textarea type="text" name="asli" class="form-control form-control-lg" required></textarea>
                        </div>
                        </div>
