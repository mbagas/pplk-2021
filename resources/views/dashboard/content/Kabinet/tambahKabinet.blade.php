      ...
      <div class="card-body">
        <form method="POST" action="{{ route('dashboard.kabinet.store') }}" enctype="multipart/form-data">
          ...
          <div class="mb-3 row">
            ...
            <div class="col-sm-10">
              <input type="text" name="presiden" class="form-control  " required>
            </div>
          </div>
          ...
          <div class="mb-3 row">
            ...
            <div class="col-sm-10">
              <input type="text" name="sekjen" class="form-control  ">
            </div>
          </div>
          <div class="mb-3 row">
            <label class="col-sm-2 col-form-label col-form-label-lg">Organigram</label>
            <div class="col-sm-10">
              <input type="file" name="organigram" class="form-control  " required>
            </div>
          </div>
          ...
          <div class="mb-3 row">
            ...
            <div class="col-sm-10">
              <input type="text" name="filosofiLogo" class="form-control  " required>
            </div>
          </div>
          <div class="mb-3 row">
