      ...
      <div class="card-body">
        ...
        <form method="POST" action="{{ route('dashboard.senat.update', $result->id) }}">
          ...
          <div class="mb-3 row">
            ...
            <div class="col-sm-10">
              <input type="text" name="ketua" class="form-control form-control-lg" value="{{ $result->ketua }}" required>
            </div>
          </div>
          ...
          <div class="mb-3 row">
            ...
            <div class="col-sm-10">
              <input type="text" name="website" class="form-control form-control-lg" value="{{ $result->website }}" required>
            </div>
          </div>
          ...
          <div class="mb-3 row">
            ...
            <div class="col-sm-10">
              <input type="text" name="youtube" class="form-control form-control-lg" value="{{ $result->youtube }}" required>
            </div>
          </div>
          ...
          <div class="mb-3 row">
            ...
            <div class="col-sm-10">
              <input type="text" name="instagram" class="form-control form-control-lg" value="{{ $result->instagram }}" required>
            </div>
          </div>
