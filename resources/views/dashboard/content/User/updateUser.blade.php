        ...
        <div class="card-body">
            <form method="POST" action="{{ route('dashboard.user.update', $result->id) }}">
                ...
                <label class="col-sm-3 col-form-label">{{ __('Nama') }}</label>
                    <div class="col-md-9">
                        <input id="nama" type="text" class="form-control @error('nama') is-invalid @enderror" placeholder="Nama" name="nama" value="{{ $result->nama }}" required autocomplete="off">
                        @error('nama')
                ...
                <div class="mb-3 row">
                    ...
                    <div class="col-md-9">
                        <input id="email" type="email" class="form-control @error('email') is-invalid @enderror" placeholder="Email" name="email" value="{{ $result->email }}" required autocomplete="off">
                ...
                <div class="mb-3 row">
                    ...
                    <div class="col-md-9">
                        <input id="password" type="password" class="form-control @error('password') is-invalid @enderror" placeholder="Password" name="password" value="{{ $result->password }}" required autocomplete="off">
                ...
                <div class="mb-3 row">
                    ...
                    <div class="col-md-9">
                        <input id="nim" type="nim" class="form-control @error('nim') is-invalid @enderror" placeholder="NIM" name="nim" value="{{ $result->nim }}" >
                ...
                <div class="mb-3 row">
                    ...
                    <div class="col-md-9">
                        <input type="text" name="instagram" class="form-control" value="{{ $result->instagram }}" placeholder="pplk2021">
                    </div>
                </div>
